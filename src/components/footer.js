...
const Footer = () => (
  ...
  <div className="box">
    <div className="container">
      ...
      <ul className="sns">
        <li>
          <a href="https://twitter.com/oRihaRakuN/">
            <FontAwesomeIcon icon={faTwitter} />
            <span className="sr-only">Twitter</span>
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/@mataro-channel/">
            <FontAwesomeIcon icon={faYoutube} />
            <span className="sr-only">Youtube</span>
          </a>
        </li>
        <li className="svg-icon">
          <a href="https://www.pixiv.net/users/17972676/">
        ...
        <li>
          <a href="https://www.instagram.com/oripara_kun/">
